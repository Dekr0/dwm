...
static const char *fonts[]          = { "Caskaydia Cove Nerd Font Complete Regular:size=10" };
static const char dmenufont[]       = "Caskaydia Cove Nerd Font Complete Regular:size=10";
